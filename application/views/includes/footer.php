			...
			<div class="row">
				...
				<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
					<div class="footer_widget">
						<img src="assets/images/logo-white.png" class="img-footer small mb-2" alt="" />

						<div class="address mt-2">
							www.sahardirectory.com
						</div>
						<div class="address mt-2">
							7419272427<br>hello@sahardirectory.com
						</div>
						<div class="address mt-2">
							<ul class="list-inline">
								<li class="list-inline-item"><a href="https://www.facebook.com/sahardirectory/" target="_blank" class="theme-cl"><i class="lni lni-facebook-filled"></i></a></li>
								<li class="list-inline-item"><a href="https://twitter.com/SaharDirectory/" target="_blank" class="theme-cl"><i class="lni lni-twitter-filled"></i></a></li>
								<li class="list-inline-item"><a href="https://www.youtube.com/SaharDirectory" target="_blank" class="theme-cl"><i class="lni lni-youtube"></i></a></li>
								<li class="list-inline-item"><a href="https://telegram.com/SaharDirectory/" target="_blank" class="theme-cl"><i class="lni lni-telegram-original"></i></a></li>
								<li class="list-inline-item"><a href="https://www.linkedin.com/SaharDirectory/?_l=en_US" target="_blank" class="theme-cl"><i class="lni lni-linkedin-original"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">
					<div class="footer_widget">
						<h4 class="widget_title">Legal Pages</h4>
				...
				<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">
					<div class="footer_widget">
						<h4 class="widget_title">Generate Vcard</h4>
						<ul class="footer-menu">

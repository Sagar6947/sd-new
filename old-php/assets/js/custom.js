...
let menu = document.querySelector('#business-toggle');
let navbar = document.querySelector('.goodup-dashboard-nav .business');
...
let bannerMenu = document.querySelector('#banner-toggle');
let bannerNav = document.querySelector('.goodup-dashboard-nav .banner');

bannerMenu.onclick = () => {
	bannerNav.classList.toggle('active');
	bannerMenu.classList.toggle('fa-times');
}

let accountMenu = document.querySelector('#account-toggle');
let accountNav = document.querySelector('.goodup-dashboard-nav .account');

accountMenu.onclick = () => {
	accountNav.classList.toggle('active');
	accountMenu.classList.toggle('fa-times');
}
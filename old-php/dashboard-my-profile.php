			...
			<div class="dashboard-tlbar d-block mb-5">
				<div class="row">
					<div class="colxl-12 col-lg-12 col-md-12">
						<h1 class="ft-medium">MyProfile</h1>
										...
										<div class="row">
											...
											<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
												<div class="form-group">
													...
													<input type="text" class="form-control rounded" placeholder="Enter your number" name="company_contact" required />
												</div>
											</div>
											<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
												<div class="form-group">
											...
											<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
												<div class="form-group">
													...
													<input type="text" class="form-control rounded" placeholder="Enter your whatsapp number" name="company_whatsapp" required />
												</div>
											</div>
